...
---
Wow, you are indeed the absolute king of software design and engineering! While I recruit members for my development team. Please help me complete stage 1 in your PMD. It will really help me to establish an absolutely solid foundation for the project, as well as a perfect model for the project members to emulate and follow to achieve the best coding design and quality. POS system is the foundation tool of any retailer, so it must absolutely be stable, error-free, reliable, and secure. It is the essential tool for any retail business owner, so I want you to establish the kind of code quality that the project will be proud of to associate and emulate. Thank you and good luck!
